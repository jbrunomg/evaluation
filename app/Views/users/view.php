                    ...
                    <form class="needs-validation" action="<?php echo base_url(); ?>/users/editUserToDB/<?php echo $result['idUsers'] ?>" method="post" novalidate>
                        ...
                        <div class="panel-content">
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input disabled type="text" class="form-control" id="validationCustom01" name="firstname" value="<?php echo $result['firstname'] ?>"  placeholder="First name" required>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input disabled type="text" class="form-control" id="validationCustom02" name="lastname" value="<?php echo $result['lastname'] ?>" placeholder="Last name" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input disabled type="number" class="form-control" id="validationCustom03" placeholder="mobile" name="mobile" value="<?php echo $result['mobile'] ?>" required>
                            ...
                            <div class="form-row form-group">
                                <div class="col-md-5 mb-3">
                                    ...
                                    <input disabled type="text" class="form-control" id="validationCustom04" placeholder="City" name="city" value="<?php echo $result['city'] ?>" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select disabled class="custom-select" name="state" required="">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input disabled type="text" class="form-control" id="validationCustom06" placeholder="Zip" name="zip" value="<?php echo $result['zip'] ?>" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input disabled type="text" class="form-control" id="validationCustomUsername" name="email" value="<?php echo $result['email'] ?>" placeholder="Username" aria-describedby="inputGroupPrepend" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input disabled type="password" class="form-control" id="validationCustom07" placeholder="password" name="password" value="<?php echo $result['password'] ?>" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select disabled class="form-control" id="example-select" name="level" >
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="custom-control custom-radio mb-2">
                                        <input disabled type="radio" class="custom-control-input" id="GenderMale" name="gender" value="Male" <?php if($result['gender'] == 'Male'){ echo 'checked';}else{ echo '';} ?> required="">
                                        <label class="custom-control-label" for="GenderMale">Male</label>
                                    </div>
                                    <div class="custom-control custom-radio mb-2">
                                        <input disabled type="radio" class="custom-control-input" id="GenderFemale" name="gender" value="Female" <?php if($result['gender'] == 'Female'){ echo 'checked';}else{ echo '';} ?> required="">
                                        <label class="custom-control-label" for="GenderFemale">Female</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input disabled type="radio" class="custom-control-input" id="genderPrivate" name="gender" value="Prefer not to say" <?php if($result['gender'] == 'Prefer not to say'){ echo 'checked';}else{ echo '';} ?> required="">
                        ...
                        <div class="panel-content border-faded border-left-0 border-right-0 border-bottom-0 d-flex flex-row align-items-center">
                            ...
                            <div class="custom-control custom-checkbox">
                                <input disabled type="checkbox" class="custom-control-input" id="invalidCheck" name="newsletter" value="1" <?php if($result['newsletter'] <> 0){ echo 'checked';}else{ echo '';} ?> >
