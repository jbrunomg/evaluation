                        ...
                        <div class="d-flex align-items-center container p-0">
                            <div class="page-logo width-mobile-auto m-0 align-items-center justify-content-center p-0 bg-transparent bg-img-none shadow-0 height-9 border-0">
                                <a href="javascript:void(0)" class="page-logo-link press-scale-down d-flex align-items-center">
                                    ...
                                    <span class="page-logo-text mr-1">Evaluation Bruno</span>
                                </a>
                            </div>
                            <a href="<?php echo base_url(); ?>/home/registration" class="btn-link text-white ml-auto">
                                Create Account
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col col-md-6 col-lg-7 hidden-sm-down">
                                    ...
                                    <div class="d-sm-flex flex-column align-items-center justify-content-center d-md-block">
                                        ...
                                        <div class="d-flex flex-row opacity-70">
                                            <a href="https://www.facebook.com/jadielbruno.guimaraes" class="mr-2 fs-xxl text-white">
                                                <i class="fab fa-facebook-square"></i>
                                            </a>
                                            <a href="https://twitter.com/jbrunomg" class="mr-2 fs-xxl text-white">
                                                <i class="fab fa-twitter-square"></i>
                                            </a>
                                          <!--   <a href="#" class="mr-2 fs-xxl text-white">
                                                <i class="fab fa-google-plus-square"></i>
                                            </a> -->
                                            <a href="https://www.linkedin.com/in/bruno-guimar%C3%A3es-41000850/" class="mr-2 fs-xxl text-white">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-5 col-xl-4 ml-auto">
                                    ...
                                    <div class="card p-4 rounded-plus bg-faded">
                                        <form id="js-login" novalidate="" action="<?php echo base_url() ?>/home/loginuser" method="post">
                                            <div class="form-group">
                                                <label class="form-label" for="username">Username</label>
                                                <input type="email" id="username" name="email" class="form-control form-control-lg" placeholder="your id or email" value="" required>
